...
// MARK: - Color helpers (file-scoped, дублируется в каждом файле permissions
// чтобы избежать конфликтов с одноимёнными extension'ами в
// `PermissionsOverviewView.swift` — Block K.13 v16)
