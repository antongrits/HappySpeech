...
private struct HomeTaskDetailSheet: View {
    ...
    private var actionsSection: some View {
        VStack(spacing: SpacingTokens.small) {
            // Кнопка «Начать упражнение» / «Повторить»
            HSButton(
            ...
            // Кнопка «Отметить выполненным» / «Открыть снова»
            HSButton(
            ...
            // Кнопка «Напомнить» — только если есть дедлайн
