...
// крупная иллюстрация (например, змея) и вопрос «Как звучит змея? Найди слово
// со звуком «С»». Ребёнок жмёт «Слушать» — записанный голос Ляли
// (LessonVoiceWorker) зачитывает вопрос и 4 варианта. После окончания
// воспроизведения варианты активируются.
