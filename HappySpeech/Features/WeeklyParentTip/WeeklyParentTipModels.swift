        ...
        static let initial = ViewState(
            tip: Tip(
                ...
                bodyParagraphs: [
                    ...
                    "Ребёнку 5–8 лет нужно 10–15 минут активного разговора в день, чтобы расширять словарь и грамматику. Главное — задавать открытые вопросы, требующие развёрнутого ответа."
                ],
                bulletPoints: [
