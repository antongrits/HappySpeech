...
/// Экран «Помощник по методике» (Vertex AI Search).
///
...
/// задаёт методический вопрос, получает обоснованный markdown-ответ и список
/// источников из корпуса. Уточняющие вопросы продолжают ту же сессию.
///
