...
///   Метрики Accuracy 85.8% / Macro F1 85.2% (2026-04-24) измерены на held-out
///   синтетике и **не валидированы на реальной детской речи** — это сравнительная
///   метрика, а не точность на живых детских голосах.
///
